...
| Prisma   | `bun run prisma:migrate:dev`     | runs prisma migrations in the database in dev mode  |
| Prisma   | `bun run prisma:migrate:prod`    | runs prisma migrations in the database in prod mode |
